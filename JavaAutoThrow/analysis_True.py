...
test_java_auto_throw_json1 = '../MakeJSON/output/Throw/'+test_filename1+'.json'
test_java_auto_throw_json2 = '../MakeJSON/output/Throw/'+test_filename2+'.json'
test_java_auto_throw_json3 = '../MakeJSON/output/Throw/'+test_filename3+'.json'
test_java_auto_throw_json4 = '../MakeJSON/output/Throw/'+test_filename4+'.json'
...
wordvec_path = "Wordvec_Model/" + model_filename1 + "_" + str(model_count) + ".model"
wordvec_model = Word2Vec.load(wordvec_path)
vocabulary = wordvec_model.wv.vocab

wordvec_path2 = "Wordvec_Model/" + model_filename2 + "_" + str(model_count) + ".model"
wordvec_model2 = Word2Vec.load(wordvec_path2)
vocabulary2 = wordvec_model2.wv.vocab

wordvec_path3 = "Wordvec_Model/" + model_filename3 + "_" + str(model_count) + ".model"
wordvec_model3 = Word2Vec.load(wordvec_path3)
vocabulary3 = wordvec_model3.wv.vocab

wordvec_path4 = "Wordvec_Model/" + model_filename4 + "_" + str(model_count) + ".model"
wordvec_model4 = Word2Vec.load(wordvec_path4)
vocabulary4 = wordvec_model4.wv.vocab

#Preprocessing test data
with open(test_java_auto_throw_json1,encoding='utf-8-sig') as test_data_file1:
...
for item in t_data1:
    ...
    test_throw.append(item['isThrow'])
    test_path.append(item['path'])
    test_method.append(item['method'])

#Preprocessing test data2
with open(test_java_auto_throw_json2,encoding='utf-8-sig') as test_data_file2:
...
for item in t_data2:
    ...
    test_throw2.append(item['isThrow'])
    test_path2.append(item['path'])
    test_method2.append(item['method'])

#Preprocessing test data3
with open(test_java_auto_throw_json3,encoding='utf-8-sig') as test_data_file3:
...
for item in t_data3:
    ...
    test_throw3.append(item['isThrow'])
    test_path3.append(item['path'])
    test_method3.append(item['method'])
    
#Preprocessing test data4
with open(test_java_auto_throw_json4,encoding='utf-8-sig') as test_data_file4:
...
for item in t_data4:
    ...
    test_throw4.append(item['isThrow'])
...
for old_index in range(len(test_data)):
    ...
    test_throw[old_index], test_throw[new_index] = test_throw[new_index], test_throw[old_index]
    ...
    test_throw2[old_index], test_throw2[new_index] = test_throw2[new_index], test_throw2[old_index]
    ...
    test_throw3[old_index], test_throw3[new_index] = test_throw3[new_index], test_throw3[old_index]
    ...
    test_throw4[old_index], test_throw4[new_index] = test_throw4[new_index], test_throw4[old_index]
...
test_throw = test_throw[(model_test_rate-1)*splitLength:model_test_rate*splitLength-1]
...
test_throw2 = test_throw2[(model_test_rate-1)*splitLength2:model_test_rate*splitLength2-1]
...
test_throw3 = test_throw3[(model_test_rate-1)*splitLength3:model_test_rate*splitLength3-1]
...
test_throw4 = test_throw4[(model_test_rate-1)*splitLength4:model_test_rate*splitLength4-1]
...
for j, item in enumerate(test_data2):
    ...
    if len(current_test_filter)>=min_sentence_len2:
        ...
        updated_test_throw2.append(test_throw2[j])
...
for j, item in enumerate(test_data3):
    ...
    if len(current_test_filter)>=min_sentence_len3:
        ...
        updated_test_throw3.append(test_throw3[j])
...
for j, item in enumerate(test_data4):
    ...
    if len(current_test_filter)>=min_sentence_len4:
        ...
        updated_test_throw4.append(test_throw4[j])
...
for i, data in enumerate(updated_test_throw):
    if data == 1:
        ...
        test_zero += 1
for i, data in enumerate(updated_test_throw2):
    if data == 1:
        test_one2 += 1
    else:
        test_zero2 += 1
for i, data in enumerate(updated_test_throw3):
    if data == 1:
        test_one3 += 1
    else:
        test_zero3 += 1
for i, data in enumerate(updated_test_throw4):
    if data == 1:
        test_one4 += 1
    else:
        test_zero4 += 1
...
#'''
    ...
    count_zero = 0
    count_one = 0
    for i, item in enumerate(updated_test_throw2):
        if item == 0 and count_zero <= test_limit_zero2:
            final_test_data2.append(updated_test_data2[i])
            final_test_throw2.append(updated_test_throw2[i])
    ...
    count_zero = 0
    count_one = 0
    for i, item in enumerate(updated_test_throw3):
        if item == 0 and count_zero <= test_limit_zero3:
            final_test_data3.append(updated_test_data3[i])
            final_test_throw3.append(updated_test_throw3[i])
    ...
    count_zero = 0
    count_one = 0
    for i, item in enumerate(updated_test_throw4):
        if item == 0 and count_zero <= test_limit_zero4:
            final_test_data4.append(updated_test_data4[i])
            final_test_throw4.append(updated_test_throw4[i])
...
Y_test2 = np.empty(shape=[len(final_test_throw2), 1], dtype='int32')
# 1 - start of sentence, # 2 - end of sentence, # 0 - zero padding. Hence, word indices start with 3 
...
for j, curr_row in enumerate(final_test_data4):
    ...
    Y_test4[j,0] = final_test_throw4[j]

# Load model
model_json = "Model/"+str(model_test_rate)+"/JAT_"+ model_filename1+"_"+str(model_count)+"_model.json"
model_h5 = "Model/"+str(model_test_rate)+"/JAT_"+ model_filename1+"_"+str(model_count)+"_model.h5"
...
model_json2 = "Model/"+str(model_test_rate)+"/JAT_"+ model_filename2+"_"+str(model_count)+"_model.json"
model_h5_2 = "Model/"+str(model_test_rate)+"/JAT_"+ model_filename2+"_"+str(model_count)+"_model.h5"
...
model_json3 = "Model/"+str(model_test_rate)+"/JAT_"+ model_filename3+"_"+str(model_count)+"_model.json"
model_h5_3 = "Model/"+str(model_test_rate)+"/JAT_"+ model_filename3+"_"+str(model_count)+"_model.h5"
...
model_json4 = "Model/"+str(model_test_rate)+"/JAT_"+ model_filename4+"_"+str(model_count)+"_model.json"
model_h5_4 = "Model/"+str(model_test_rate)+"/JAT_"+ model_filename4+"_"+str(model_count)+"_model.h5"
...
fpr2, tpr2, threshold2 = roc_curve(final_test_throw2, preds2)
fpr3, tpr3, threshold3 = roc_curve(final_test_throw3, preds3)
fpr4, tpr4, threshold4 = roc_curve(final_test_throw4, preds4)
...
for i, data in enumerate(final_test_throw):
    if predictY[i] == 1:
        for i2, data2 in enumerate(final_test_throw2):
...
for i, data in enumerate(predictY):
    if data != Y_test[i][0]:
        code_F_method.append(final_test_method[i])
        code_F_path.append(final_test_path[i])
AST_F_method = []
AST_F_path = []
for i, data in enumerate(predictY2):
    if data != Y_test2[i][0]:
        AST_F_method.append(final_test_method2[i])
        AST_F_path.append(final_test_path2[i])
...
print(len(predictY), len(predictY2), len(Y_test), len(Y_test2))
codeT_ASTF = 0
codeF_ASTT = 0
for i, data in enumerate(code_method):
    for i2, data2 in enumerate(AST_F_method):
        if data == data2 and code_path[i] == AST_F_path[i2]:
            codeT_ASTF += 1
for i, data in enumerate(code_F_method):
    for i2, data2 in enumerate(AST_method):
        if data == data2 and code_F_path[i] == AST_path[i2]:
            codeF_ASTT += 1
print("codeT_ASTF : ", codeT_ASTF)
print("codeF_ASTT : ", codeF_ASTT)
...
idx = 0
true = 0
for i, data in enumerate(final_test_throw2):
    if data == 1:
        test_one += 1
    else:
        test_zero += 1
...
f1_score = metrics.f1_score(final_test_throw2, predictY2)
print("\nF1score : ", f1_score)
...
idx = 0
true = 0
for i, data in enumerate(final_test_throw3):
    if data == 1:
        test_one += 1
    else:
        test_zero += 1
...
f1_score = metrics.f1_score(final_test_throw3, predictY3)
print("\nF1score : ", f1_score)
...
idx = 0
true = 0
for i, data in enumerate(final_test_throw4):
    if data == 1:
        test_one += 1
    else:
        test_zero += 1
...
f1_score = metrics.f1_score(final_test_throw4, predictY4)
print("\nF1score : ", f1_score)
