...
for i in range(min_sentence_len, max_sentence_len+1):
    java_auto_exception_json = "input_data/real_last/sentence_len/data1/"+standard_input_filename+"_sentence_len"+str(i)+"_frequency"+str(min_word_frequency_word2vec)+".json"
...
standard_model_name = "Wordvec_Model/real_last/"+standard_wordvec_model_name+"_"+str(model_count)+".model"
