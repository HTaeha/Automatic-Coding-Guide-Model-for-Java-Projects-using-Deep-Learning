...
model_filename2 = test_file2 + "_frequency"+str(min_word_frequency_word2vec) 

#test_java_auto_logging_json = '../MakeJSON/output/Logging/final/'+test_file1+'.json'
test_java_auto_logging_json2 = '../MakeJSON/output/Logging/'+test_file2+'.json'
...
with open(test_java_auto_logging_json,encoding='utf-8-sig') as test_data_file:
...
'''
# Load model
model_json = "Model/"+str(model_test_rate)+"/JAL_"+ model_filename+"_ep"+str(model_ep)+"_min"+str(min_sentence_len)+"_"+str(model_count)+"_model.json"
model_h5 = "Model/"+str(model_test_rate)+"/JAL_"+ model_filename+"_ep"+str(model_ep)+"_min"+str(min_sentence_len)+"_"+str(model_count)+"_model.h5"
...
'''
model_json2 = "Model/"+str(model_test_rate)+"/JAL_"+ model_filename2+"_ep"+str(model_ep)+"_min"+str(min_sentence_len)+"_"+str(model_count)+"_model.json"
model_h52 = "Model/"+str(model_test_rate)+"/JAL_"+ model_filename2+"_ep"+str(model_ep)+"_min"+str(min_sentence_len)+"_"+str(model_count)+"_model.h5"
...
'''
for i in range(100):
    logging_keyword.append(w2cSorted_no_punc[i][0])
...
for i in range(100):
    ...
    print(i+1)
    print(w2cSorted_no_punc[i][0])
    for j, data in enumerate(final_test_logging2):
    ...
    print()
print()
print("Logging keyword : ", logging_keyword)
...
for i, data in enumerate(final_test_logging2):
    ...
    if data == 1:
        for idx in range(len(final_test_data2[i])):
            for a, keyword in enumerate(logging_keyword):
