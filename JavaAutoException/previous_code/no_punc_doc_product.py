...
input_type1 = 'AST'
input_type2 = 'code'
filename = input_file + '-CAST_d_no_punc_frequency'+str(min_word_frequency_word2vec)+"_LSTM"+str(LSTM_output_size)+"_batch64"
model_filename = input_file + '-CAST_d_no_punc_frequency'+str(min_word_frequency_word2vec)
