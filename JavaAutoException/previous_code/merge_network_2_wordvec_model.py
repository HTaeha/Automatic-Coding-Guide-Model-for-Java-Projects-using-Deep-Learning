...
input_type1 = 'AST'
input_type2 = 'code'
filename = input_file + '-CAST_m_frequency'+str(min_word_frequency_word2vec)+"_LSTM"+str(LSTM_output_size)+"_batch64"
...
wordvec_model_name2 = input_filename2 + '-CAST_m_frequency'+str(min_word_frequency_word2vec)
epoch_len = 15
