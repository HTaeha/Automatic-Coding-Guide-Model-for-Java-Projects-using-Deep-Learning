...
test_java_auto_exception_json = '../MakeJSON/output/Exception/final/'+test_file1+'.json'
test_java_auto_exception_json2 = '../MakeJSON/output/Exception/final/'+test_file2+'.json'
