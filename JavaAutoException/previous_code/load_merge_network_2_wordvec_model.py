...
test_input_file = sys.argv[1]#"guava"
test_filename = test_input_file + "-AST"
test_filename2 = test_input_file + "-code"

model_input_file = sys.argv[2]#"hbase"
load_model_filename = model_input_file + "-CAST_m"
wordvec_model_name = model_input_file + "-AST_CAST_m"
wordvec_model_name2 = model_input_file + "-code_CAST_m"

test_java_auto_exception_json = '../MakeJSON/output/Exception/real_final/'+test_filename+'.json'
...
filename = "load_"+load_model_filename+"-test_"+test_input_file+'-CAST_m'
count = 1

#If balance = False, test all data
#If balance = True, test_limit_zero + test_limit_one
balance = bool(sys.argv[4])
...
wordvec_path = "Wordvec_Model/real_final/" + wordvec_model_name + "_" + str(model_count) + ".model"
wordvec_model = Word2Vec.load(wordvec_path)
vocabulary = wordvec_model.wv.vocab

wordvec_path2 = "Wordvec_Model/real_final/" + wordvec_model_name2 + "_" + str(model_count) + ".model"
...
if balance:
    ...
    test_limit_zero = min(test_one, test_zero)
    test_limit_one = test_limit_zero
...
# Load model
model_json = "Model/real_final/"+str(model_test_rate)+"/best/JAE_"+ load_model_filename+"_"+str(model_count)+"_model.json"
model_h5 = "Model/real_final/"+str(model_test_rate)+"/best/JAE_"+ load_model_filename+"_"+str(model_count)+"_model.h5"
...
TP_file_name = "Code_snippet/real_final/"+str(model_test_rate)+"/TP_"+filename+"_"+str(count)+".txt"
FP_file_name = "Code_snippet/real_final/"+str(model_test_rate)+"/FP_"+filename+"_"+str(count)+ ".txt"
TN_file_name = "Code_snippet/real_final/"+str(model_test_rate)+"/TN_"+filename+"_"+str(count)+ ".txt"
FN_file_name = "Code_snippet/real_final/"+str(model_test_rate)+"/FN_"+filename+"_"+str(count)+ ".txt"
...
roc_name = "ROC/real_final/"+str(model_test_rate)+"/JAE_"+filename+"_"+str(count)
