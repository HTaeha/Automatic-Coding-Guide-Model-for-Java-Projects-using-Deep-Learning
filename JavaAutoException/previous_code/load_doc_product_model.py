...
load_model_filename = model_input_file + "-CAST_d"
...
filename = "load_"+load_model_filename+"-test_"+test_input_file + '-CAST_d'
count = 1
...
wordvec_path = "Wordvec_Model/real_final/" + load_model_filename +"_" + str(model_count) + ".model"
