...
java_auto_exception_json = '../MakeJSON/output/Exception/final/'+input_filename+'.json'
filename = input_filename + "_lowercase_split" # + "_balanced_max"+str(max_sentence_len)+"_masking"_LSTM"+str(LSTM_output_size)
epoch_len = 15
...
#current_data = current_sentence_filter
    ...
    all_data.append(lowercase_data)
...
wordvec_model.save("Wordvec_Model/final/"+str(test_rate)+"/"+filename+"_"+str(count)+".model")
...
#TP, FP, TN, FN file save.
    TP_file_name = "Code_snippet/final/"+str(test_rate)+"/TP_"+filename+"_"+str(count)+".txt"
    FP_file_name = "Code_snippet/final/"+str(test_rate)+"/FP_"+filename+"_"+str(count)+ ".txt"
    TN_file_name = "Code_snippet/final/"+str(test_rate)+"/TN_"+filename+"_"+str(count)+ ".txt"
    FN_file_name = "Code_snippet/final/"+str(test_rate)+"/FN_"+filename+"_"+str(count)+ ".txt"
...
#'''
    ...
    roc_name = "ROC/final/"+str(test_rate) +"/JAE_"+filename+"_"+str(count)
    plt.savefig(roc_name)
    roc_count += 1

    model_json = model.to_json()
    model_name = "Model/final/"+str(test_rate) + "/JAE_"+filename+"_"+str(count)+"_model.json"
    weight_name = "Model/final/"+str(test_rate) + "/JAE_"+filename+"_"+str(count)+"_model.h5"
