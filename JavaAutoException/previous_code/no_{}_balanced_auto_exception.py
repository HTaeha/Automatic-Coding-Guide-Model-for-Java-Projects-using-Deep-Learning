...
filename = input_filename+"_no_{}_frequency"+str(min_word_frequency_word2vec)+"_LSTM"+str(LSTM_output_size)+"_batch64"
#filename = input_filename+"_combine_wordvec_frequency"+str(min_word_frequency_word2vec)+"_LSTM"+str(LSTM_output_size)+"_batch64"
model_filename = input_filename+"_no_{}_frequency"+str(min_word_frequency_word2vec)
