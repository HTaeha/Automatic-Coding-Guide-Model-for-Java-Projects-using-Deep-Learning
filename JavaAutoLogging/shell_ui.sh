...
python3 sentence_java_auto_logging.py ${input_data} 4 code AST CAST depth_num ${test_rate} ${min_word_frequency}  ${first_execute} ${min} ${max}&> CV/end2/${test_rate}/${input_data}-CAST_m_cACd_sentence_balanced_min${min}_max${max}_frequency${min_word_frequency}.txt
