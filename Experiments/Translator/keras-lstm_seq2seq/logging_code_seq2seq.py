...
filename = "S2S-"+input_file + '_' + input_type + "-"+target_type+ "_no_space_sentence_balanced_min"+str(st_min_sentence_len)+"_max"+str(st_max_sentence_len)+"_frequency"+str(min_word_frequency_word2vec)
