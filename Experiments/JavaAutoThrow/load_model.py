...
test_java_auto_throw_json = '../MakeJSON/output/Throw/'+test_filename+'.json'
...
wordvec_path = "Wordvec_Model/" + model_filename +"_" + str(model_count) + ".model"
wordvec_model = Word2Vec.load(wordvec_path)
vocabulary = wordvec_model.wv.vocab

#Preprocessing test data
with open(test_java_auto_throw_json,encoding='utf-8-sig') as test_data_file:
...
# Load model
model_json = "Model/"+str(model_test_rate)+"/JAT_"+ model_filename+"_"+str(model_count)+"_model.json"
model_h5 = "Model/"+str(model_test_rate)+"/JAT_"+ model_filename+"_"+str(model_count)+"_model.h5"
...
TP_file_name = "Code_snippet/"+str(model_test_rate)+"/TP_"+filename+"_"+str(count)+".txt"
FP_file_name = "Code_snippet/"+str(model_test_rate)+"/FP_"+filename+"_"+str(count)+ ".txt"
TN_file_name = "Code_snippet/"+str(model_test_rate)+"/TN_"+filename+"_"+str(count)+ ".txt"
FN_file_name = "Code_snippet/"+str(model_test_rate)+"/FN_"+filename+"_"+str(count)+ ".txt"
...
roc_name = "ROC/final/"+str(model_test_rate)+"/JAT_"+filename+"_"+str(count)
