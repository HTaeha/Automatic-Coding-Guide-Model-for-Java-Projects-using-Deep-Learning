...
for i in range(input_file_num):
    java_auto_logging_json[i] = "../MakeJSON/output/Logging/end/"+input_filename[i]+".json"
standard_java_auto_logging_json = '../MakeJSON/output/Logging/end/'+standard_input_filename+'.json'
...
model_name = "Wordvec_Model/end/"+wordvec_model_name+"_"+str(count)+".model"
standard_model_name = "Wordvec_Model/end/"+standard_wordvec_model_name+"_"+str(count)+".model"
...
#ev.histogram_ground_truth(hist_filename, all_data, all_logging, max_sentence_len, 10, 1)
...
if input_file_num >= 2:
    ...
    # Make model input.
    X_train2, Y_train2 = pr.create_deep_learning_input_data(train_data2, train_logging2, max_sentence_len, embed_size_word2vec, vocabulary, wordvec_model)
    X_test2, Y_test2 = pr.create_deep_learning_input_data(test_data2, test_logging2, max_sentence_len, embed_size_word2vec, vocabulary, wordvec_model)
...
if input_file_num >= 3:
    ...
    X_test3, Y_test3 = pr.create_deep_learning_input_data(test_data3, test_logging3, max_sentence_len, embed_size_word2vec, vocabulary, wordvec_model)
...
if input_file_num >= 4:
    ...
    # Make model input.
    X_train4, Y_train4 = pr.create_deep_learning_input_data(train_data4, train_logging4, max_sentence_len, embed_size_word2vec, vocabulary, wordvec_model)
    X_test4, Y_test4 = pr.create_deep_learning_input_data(test_data4, test_logging4, max_sentence_len, embed_size_word2vec, vocabulary, wordvec_model)
'''
...
'''
# Load model
model_json = "Model/end/"+str(model_test_rate)+"/best/JAL_"+model_filename+"_"+str(model_count)+"_model.json"
model_h5 = "Model/end/"+str(model_test_rate)+"/best/JAL_"+model_filename+"_"+str(model_count)+"_model.h5"
