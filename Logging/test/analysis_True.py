...
test_java_auto_logging_json1 = '../MakeJSON/output/Logging/real_final/'+test_filename1+'.json'
test_java_auto_logging_json2 = '../MakeJSON/output/Logging/real_final/'+test_filename2+'.json'
test_java_auto_logging_json3 = '../MakeJSON/output/Logging/real_final/'+test_filename3+'.json'
test_java_auto_logging_json4 = '../MakeJSON/output/Logging/real_final/'+test_filename4+'.json'
...
# Load model
model_json = "Model/real_final/"+str(model_test_rate)+"/JAL_"+ model_filename1+"_"+str(model_count)+"_model.json"
model_h5 = "Model/real_final/"+str(model_test_rate)+"/JAL_"+ model_filename1+"_"+str(model_count)+"_model.h5"
...
model_json2 = "Model/real_final/"+str(model_test_rate)+"/JAL_"+ model_filename2+"_"+str(model_count)+"_model.json"
model_h5_2 = "Model/real_final/"+str(model_test_rate)+"/JAL_"+ model_filename2+"_"+str(model_count)+"_model.h5"
...
model_json3 = "Model/real_final/"+str(model_test_rate)+"/JAL_"+ model_filename3+"_"+str(model_count)+"_model.json"
model_h5_3 = "Model/real_final/"+str(model_test_rate)+"/JAL_"+ model_filename3+"_"+str(model_count)+"_model.h5"
...
model_json4 = "Model/real_final/"+str(model_test_rate)+"/JAL_"+ model_filename4+"_"+str(model_count)+"_model.json"
model_h5_4 = "Model/real_final/"+str(model_test_rate)+"/JAL_"+ model_filename4+"_"+str(model_count)+"_model.h5"
...
average_predict = np.average(predict, axis=0)
print("code average : ",average_predict)
std_predict = np.std(predict, axis=0)
print("code std : ", std_predict)
average_predict = np.average(predict2, axis=0)
print("AST average : ",average_predict)
std_predict = np.std(predict2, axis=0)
print("AST std : ", std_predict)
average_predict = np.average(predict3, axis=0)
print("CAST average : ",average_predict)
std_predict = np.std(predict3, axis=0)
print("CAST std : ", std_predict)
average_predict = np.average(predict4, axis=0)
print("CAST_s average : ",average_predict)
std_predict = np.std(predict4, axis=0)
print("CAST_s std : ", std_predict)
...
for i, data in enumerate(final_test_logging):
    if predictY[i] == 1:
        for i2, data2 in enumerate(final_test_logging2):
...
for i, data in enumerate(predictY):
    if data == Y_test[i][0]:
        ...
        predict_T.append(predict[i])
    else:
        predict_F.append(predict[i])

average_predict = np.average(predict_T, axis=0)
print('code_T average : ', average_predict)
std_predict = np.std(predict_T, axis=0)
print('code_T std : ',std_predict)
average_predict = np.average(predict_F, axis=0)
print('code_F average : ', average_predict)
std_predict = np.std(predict_F, axis=0)
print('code_F std : ',std_predict)

np.asarray(predict_T)
np.asarray(predict_F)
histogram_predict("code_True", predict_T, 11, 1)
histogram_predict("code_False", predict_F, 11, 3)
...
average_predict = np.average(predict_T, axis=0)
print('AST_T average : ', average_predict)
std_predict = np.std(predict_T, axis=0)
print('AST_T std : ',std_predict)
average_predict = np.average(predict_F, axis=0)
print('AST_F average : ', average_predict)
std_predict = np.std(predict_F, axis=0)
print('AST_F std : ',std_predict)

np.asarray(predict_T)
np.asarray(predict_F)
histogram_predict("AST_True", predict_T, 11, 5)
histogram_predict("AST_False", predict_F, 11, 7)
...
average_predict = np.average(predict_T, axis=0)
print('CAST_T average : ', average_predict)
std_predict = np.std(predict_T, axis=0)
print('CAST_T std : ',std_predict)
average_predict = np.average(predict_F, axis=0)
print('CAST_F average : ', average_predict)
std_predict = np.std(predict_F, axis=0)
print('CAST_F std : ',std_predict)

np.asarray(predict_T)
np.asarray(predict_F)
histogram_predict("CAST_True", predict_T, 11, 9)
histogram_predict("CAST_False", predict_F, 11, 11)
...
average_predict = np.average(predict_T, axis=0)
print('CAST_s_T average : ', average_predict)
std_predict = np.std(predict_T, axis=0)
print('CAST_s_T std : ',std_predict)
average_predict = np.average(predict_F, axis=0)
print('CAST_s_F average : ', average_predict)
std_predict = np.std(predict_F, axis=0)
print('CAST_s_F std : ',std_predict)

np.asarray(predict_T)
np.asarray(predict_F)
histogram_predict("CAST_s_True", predict_T, 11, 13)
histogram_predict("CAST_s_False", predict_F, 11, 15)
