...
test_java_auto_exception_json = '../MakeJSON/output/ByteCode/'+test_filename+'.json'
...
# Load model
model_json = "Model/"+str(model_test_rate)+"/JAE_"+ model_filename+"_"+str(model_count)+"_model.json"
model_h5 = "Model/"+str(model_test_rate)+"/JAE_"+ model_filename+"_"+str(model_count)+"_model.h5"
