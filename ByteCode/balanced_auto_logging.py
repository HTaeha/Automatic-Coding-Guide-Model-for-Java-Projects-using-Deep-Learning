...
java_auto_logging_json = '../MakeJSON/output/ByteCode/'+input_filename+'.json'
...
#'''
    ...
    roc_name = "ROC/"+str(test_rate) +"/JAL_"+filename+"_"+str(count)
    plt.savefig(roc_name)
    roc_count += 1

    model_json = model.to_json()
    model_name = "Model/"+str(test_rate) + "/JAL_"+filename+"_"+str(count)+"_model.json"
    weight_name = "Model/"+str(test_rate) + "/JAL_"+filename+"_"+str(count)+"_model.h5"
