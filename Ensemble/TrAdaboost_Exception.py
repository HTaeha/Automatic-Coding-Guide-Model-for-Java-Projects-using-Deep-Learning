...
wordvec_model2.save("Wordvec_Model/Exception/"+wordvec_model_name2+"_"+str(count)+".model")
sys.exit(1)
'''
...
wordvec_path2 = "../JavaAutoException/Wordvec_Model/real_final/"+wordvec_model_name2+"_"+str(model_count)+".model"
...
if model_test_rate == 1:
    ...
    train_exception2 = all_exception2[:(model_test_rate-1)*splitLength-1]+ all_exception2[model_test_rate*splitLength:]
    test_exception2 = all_exception2[(model_test_rate-1)*splitLength:model_test_rate*splitLength-1]
...
d2_train2_dataset = X_train2.reshape((nsamples, nx*ny))

preds = tr.tradaboost(d2_train_dataset, d2_train2_dataset, Y_train, Y_train, d2_test_dataset, epoch_len)
true = 0
for i, data in enumerate(preds):
    if data == final_test_exception[i]:
        true += 1
print('Accuracy : ', true/len(preds)*100)
...
print(w3[0].shape, w3[1].shape, w3[2].shape)
print(w4[0].shape, w4[1].shape, w4[2].shape)
#print(w5[0].shape)#, w5[1].shape)
#print(w6[0].shape)#, w6[1].shape)
#print(w7[0].shape)#, w7[1].shape)
#print(w8[0].shape)#, w8[1].shape)
print(w9[0].shape, w9[1].shape)
...
temp_w.append(a)
temp_w.append(b)
l9.set_weights(temp_w)
print(l9.get_weights())

model_json2 = "../JavaAutoException/Model/real_final/"+str(model_test_rate)+"/JAE_"+model_filename2+"_"+str(model_count)+"_model.json"
model_h5_2 = "../JavaAutoException/Model/real_final/"+str(model_test_rate)+"/JAE_"+model_filename2+"_"+str(model_count)+"_model.h5"
...
print('model2 layer', model2.layers)
