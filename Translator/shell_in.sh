...
python3 word2vec_logging_code_seq2seq.py ${input_data} ${input_type} ${target_type} ${min_word_frequency_word2vec} ${min} ${max} 1 &> Result/test.txt
