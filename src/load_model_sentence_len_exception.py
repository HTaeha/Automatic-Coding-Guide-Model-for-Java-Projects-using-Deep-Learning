...
for i in range(min_sentence_len, max_sentence_len+1):
    java_auto_logging_json = "../JavaAutoException/input_data/end/sentence_len/data1/"+standard_input_filename+"_sentence_len"+str(i)+"_frequency"+str(min_word_frequency_word2vec)+".json"
...
if input_file_num >= 1:
    for i in range(min_sentence_len, max_sentence_len+1):
        java_auto_logging_json = "../JavaAutoException/input_data/end/sentence_len/data1/"+input_filename[0]+"_sentence_len"+str(i)+"_frequency"+str(min_word_frequency_word2vec)+".json"
        temp_data, temp_logging, temp_path, temp_method = pr.open_data(java_auto_logging_json, label_name)
        if i == min_sentence_len:
...
if input_file_num >= 2:
    for i in range(min_sentence_len, max_sentence_len+1):
        java_auto_logging_json = "../JavaAutoException/input_data/end/sentence_len/data1/"+input_filename[1]+"_sentence_len"+str(i)+"_frequency"+str(min_word_frequency_word2vec)+".json"
        temp_data, temp_logging, temp_path, temp_method = pr.open_data(java_auto_logging_json, label_name)
        if i == min_sentence_len:
...
if input_file_num >= 3:
    for i in range(min_sentence_len, max_sentence_len+1):
        java_auto_logging_json = "../JavaAutoException/input_data/end/sentence_len/data1/"+input_filename[2]+"_sentence_len"+str(i)+"_frequency"+str(min_word_frequency_word2vec)+".json"
        temp_data, temp_logging, temp_path, temp_method = pr.open_data(java_auto_logging_json, label_name)
        if i == min_sentence_len:
...
if input_file_num >= 4:
    for i in range(min_sentence_len, max_sentence_len+1):
        java_auto_logging_json = "../JavaAutoException/input_data/end/sentence_len/data1/"+input_filename[3]+"_sentence_len"+str(i)+"_frequency"+str(min_word_frequency_word2vec)+".json"
        temp_data, temp_logging, temp_path, temp_method = pr.open_data(java_auto_logging_json, label_name)
        if i == min_sentence_len:
...
model_name = "Wordvec_Model/end/"+wordvec_model_name+"_"+str(model_count)+".model"
standard_model_name = "Wordvec_Model/end/"+standard_wordvec_model_name+"_"+str(model_count)+".model"
