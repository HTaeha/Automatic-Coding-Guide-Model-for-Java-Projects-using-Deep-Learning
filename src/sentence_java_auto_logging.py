...
if input_file_num >= 1:
    for i in range(st_min_sentence_len, st_max_sentence_len+1):
        java_auto_logging_json = "../input_data/sentence_len/data1/"+input_file+'/'+input_filename[0]+"_sentence_len"+str(i)+"_frequency"+str(min_word_frequency_word2vec)+".json"
...
if input_file_num >= 2:
    for i in range(st_min_sentence_len, st_max_sentence_len+1):
        java_auto_logging_json = "../input_data/sentence_len/data1/"+input_file+'/'+input_filename[1]+"_sentence_len"+str(i)+"_frequency"+str(min_word_frequency_word2vec)+".json"
        temp_data, temp_logging, temp_path, temp_method = pr.open_data(java_auto_logging_json, label_name)
        if i == st_min_sentence_len:
...
if input_file_num >= 3:
    for i in range(st_min_sentence_len, st_max_sentence_len+1):
        java_auto_logging_json = "../input_data/sentence_len/data1/"+input_file+'/'+input_filename[2]+"_sentence_len"+str(i)+"_frequency"+str(min_word_frequency_word2vec)+".json"
        temp_data, temp_logging, temp_path, temp_method = pr.open_data(java_auto_logging_json, label_name)
        if i == st_min_sentence_len:
...
if input_file_num >= 4:
    for i in range(st_min_sentence_len, st_max_sentence_len+1):
        java_auto_logging_json = "../input_data/sentence_len/data1/"+input_file+'/'+input_filename[3]+"_sentence_len"+str(i)+"_frequency"+str(min_word_frequency_word2vec)+".json"
        temp_data, temp_logging, temp_path, temp_method = pr.open_data(java_auto_logging_json, label_name)
        if i == st_min_sentence_len:
...
merge_test_data = []
if input_file_num >= 1:
    pr.data_shuffle(all_data, seed)
    pr.data_shuffle(all_logging, seed)
    pr.data_shuffle(all_path, seed)
    pr.data_shuffle(all_method, seed)
...
if input_file_num >= 2:
    pr.data_shuffle(all_data2, seed)
    pr.data_shuffle(all_logging2, seed)
    pr.data_shuffle(all_path2, seed)
    pr.data_shuffle(all_method2, seed)
...
if input_file_num >= 3:
    pr.data_shuffle(all_data3, seed)
    pr.data_shuffle(all_logging3, seed)
    pr.data_shuffle(all_path3, seed)
    pr.data_shuffle(all_method3, seed)
...
if input_file_num >= 4:
    pr.data_shuffle(all_data4, seed)
    pr.data_shuffle(all_logging4, seed)
    pr.data_shuffle(all_path4, seed)
    pr.data_shuffle(all_method4, seed)
...
for ep in range(epoch_len) :
    ...
    '''
    # Save ROC graph.
    roc_name = "../ROC/"+str(test_rate) +"/JAL_"+filename+"_ep"+str(ep+1)
    ev.save_ROC(roc_count, Y_test_1d, preds, roc_name)
    roc_count += 1

    # Save model.
    model_name = "../Model/"+str(test_rate) + "/JAL_"+filename+"_ep"+str(ep+1)+"_model.json"
    weight_name = "../Model/"+str(test_rate) + "/JAL_"+filename+"_ep"+str(ep+1)+"_model.h5"
    md.save_model(model, model_name, weight_name)
