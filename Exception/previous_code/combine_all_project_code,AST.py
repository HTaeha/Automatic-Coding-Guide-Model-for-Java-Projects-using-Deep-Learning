...
input_filename4 = input_file+'-'+input_type2
input_filename5 = input_file2+'-'+input_type2
input_filename6 = input_file3+'-'+input_type2
...
java_auto_exception_json4 = '../MakeJSON/output/Exception/real_final/'+input_filename4+'.json'
java_auto_exception_json5 = '../MakeJSON/output/Exception/real_final/'+input_filename5+'.json'
java_auto_exception_json6 = '../MakeJSON/output/Exception/real_final/'+input_filename6+'.json'
...
#current_data = current_sentence_filter
    ...
    all_path.append(item['path'])
    all_method.append(item['method'])
with open(java_auto_exception_json4,encoding='utf-8-sig') as data_file:           
    data = json.loads(data_file.read(), strict=False)
...
#current_data = current_sentence_filter
    ...
    all_path.append(item['path'])
    all_method.append(item['method'])
with open(java_auto_exception_json5,encoding='utf-8-sig') as data_file:           
    data = json.loads(data_file.read(), strict=False)
...
#current_data = current_sentence_filter
    ...
    all_path.append(item['path'])
    all_method.append(item['method'])
with open(java_auto_exception_json6,encoding='utf-8-sig') as data_file:           
    data = json.loads(data_file.read(), strict=False)
