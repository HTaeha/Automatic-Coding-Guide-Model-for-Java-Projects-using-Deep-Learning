...
#If balance = 0, test all data
#If balance = 1, test_limit_zero + test_limit_one
...
# Load model
model_json = "Model/real_final/"+str(model_test_rate)+"/best/JAE_"+ model_filename+"_"+str(model_count)+"_model.json"
model_h5 = "Model/real_final/"+str(model_test_rate)+"/best/JAE_"+ model_filename+"_"+str(model_count)+"_model.h5"
