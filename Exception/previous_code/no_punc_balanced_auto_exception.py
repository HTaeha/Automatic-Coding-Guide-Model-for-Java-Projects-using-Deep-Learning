...
filename = input_filename+"_no_punc_frequency"+str(min_word_frequency_word2vec)+"_LSTM"+str(LSTM_output_size)+"_batch64" # + "_balanced_max"+str(max_sentence_len)+"_masking"_LSTM"+str(LSTM_output_size)
model_filename = input_filename+"_no_punc_frequency"+str(min_word_frequency_word2vec)
epoch_len = 15
