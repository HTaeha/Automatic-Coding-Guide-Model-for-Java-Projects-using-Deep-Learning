...
java_auto_exception_json = '../MakeJSON/output/Exception/real_last/'+input_filename+'.json'
...
#current_data = current_sentence_filter
    ...
    logistic_label1.append(item['isException'])
    logistic_data2.append(len(current_data))
    logistic_label2.append(item['isException'])
...
for i,item in enumerate(final_train_data):
    ...
    Y_train1.append(final_train_exception[i])
    X_train2.append(len(item))
    Y_train2.append(final_train_exception[i])
for i,item in enumerate(final_test_data):
    ...
    Y_test1.append(final_test_exception[i])
    X_test2.append(len(item))
    Y_test2.append(final_test_exception[i])
