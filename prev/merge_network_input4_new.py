...
model_name = "Wordvec_Model/test/"+wordvec_model_name+"_"+str(count)+".model"
standard_model_name = "Wordvec_Model/test/"+standard_wordvec_model_name+"_"+str(count)+".model"
